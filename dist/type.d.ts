...
export declare type FourElemArray<T> = [T, T, T, T];
export declare type vanishingPointAxesStrings = 'xPositive' | 'xNegative' | 'yPositive' | 'yNegative' | 'zPositive' | 'zNegative';
export declare type FSpyJsonTransformRows = [[number, number, number, number], [number, number, number, number], [number, number, number, number], [number, number, number, number]];
